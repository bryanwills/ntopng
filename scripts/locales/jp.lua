local lang = {
  ...
  ["menu.reason.lightview"] = "「概要」では利用できません",
  ...
  ["menu.suggestion.lightview"] = "これにアクセスするには通常のインターフェイスを選択してください",
  ...
  ["about"] = {
    ...
    ["handle_licenses"] = {
      ...
      ["order_id"] = "注文ID",
      ["page_notes_refresh"] = "表（右上隅）の上にある <button class='btn btn-link mb-1 p-0'><i class='fas fa-cloud-arrow-down me-1'></i>更新</button> をクリックして、ライセンス、ステータス、ECC を再読み込みします。 ntop サーバーから。",
      ["page_notes_credentials"] = "表の上（右上隅）にある <button class='btn btn-link mb-1 p-0'><i class='fas fa-cog me-1'></i>認証情報</button> をクリックして、以前に設定した認証情報（メールと認証トークン）を変更します。これらの情報は、ntop サーバーからライセンス/注文を取得するために使用されます。",
      ["page_notes_last_update"] = "表の上（左上隅）の <span class='text-muted'>最終更新</span> には、情報が ntop サーバーから最後に取得された時間が表示されます。 <button class='btn btn-link mb-1 p-0'><i class='fas fa-cloud-arrow-down me-1'></i>更新</button> をクリックして更新します。",
      ["page_notes_license_info"] = "ライセンスの横にある <button class='btn btn-sm btn-primary btn-primary mb-1'><i class='fa-solid fa-circle-info'></i></button> をクリックして、ライセンス情報 (メンテナンス、製品など) を表示します。",
      ["page_notes_license_renew"] = "ライセンスの横にある <button class='btn btn-sm btn-primary btn-primary'><i class='fa-solid fa-cart-shopping'></i></button> をクリックして更新します。",
      ["page_title"] = "ライセンス",
      ["product"] = "製品",
  ...
  ["license_page"] = {
    ...
    ["activation_error_invalid_format"] = "無効なアクティベーション コードです。文字抜けや余分なスペース、改行がないか確認しながら、もう一度コピーして貼り付けてください。",
    ["activation_error_system_id_mismatch"] = "アクティベーション コードがこのインスタンスの SystemID と一致しません。正しいライセンスに対して生成したことを確認するか、SystemID が変更されている場合は<a href='https://www.ntop.org/faq/how-can-i-transfer-a-license-to-a-new-server/' target='_blank' rel='noopener noreferrer'>ライセンスを転送</a>してください。",
    ...
    ["note_renew_license_blog"] = "ライセンスの更新に関する情報は、<a href='https://www.ntop.org/faq/how-can-i-renew-maintenance-for-commercial-products/'>こちら</a>でご覧いただけます。",
    ["note_renew_license"] = "ライセンスを確認して更新するには、「ライセンスの処理」ボタンをクリックしてください。",
  ...
  ["prefs"] = {
    ...
    ["locked_requires_enterprise"] = "%{product} Enterprise が必要です。",
    ...
    ["locked_requires_nanalyst"] = "nAnalyst が必要です。",
    ["locked_requires_pro"] = "%{product} Pro が必要です。",
    ["locked_set_from_cmdline"] = "起動時にコマンドラインから設定され、ここでは変更できません。",
    ["local_auth"] = "ローカル認証",
